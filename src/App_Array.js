...
class App_Array extends Component {
  personId = 1;
  ...
  render() {
    ...
    const row = this.state.persons.map(person => 
      <Person key={person.id} handleUpdate={this.handleUpdate} handleRemove={this.handleRemove} person={person}></Person>
    );
